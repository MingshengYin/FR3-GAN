...
for i, rx_type in enumerate(cfg.rx_types):
    ...
    for iplot in range(nplot):
            ...
            if iplot == 0:
                # ax[0].scatter(pl_omni_plot[iplot][I],pl4_omni_plot[iplot][I],s=9, c=colors[iplot],alpha = 0.2)
                ...
                # ax[1].scatter(pl_omni_plot[iplot][I],pl4_omni_plot[iplot][I],s=9, c=colors[iplot],
                              # alpha = 0.2)
                sns.kdeplot(pl_omni_plot[iplot][I], pl2_omni_plot[iplot][I], fill = True, ax=ax[1])
                sns.set_style("whitegrid")            
