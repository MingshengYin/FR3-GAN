...
with open('dict_outdoor_whole.p', 'rb') as handle:
    data = pickle.load(handle)

"""
Delete outage
"""
print('Number of links before delete outage : ', data['dvec'].shape[0])
not_outage_idx = np.nonzero(data['link_state'])
print('Got index for non-outage')

for key in data:
    data[key] = data[key][not_outage_idx]

print('Number of links after delete outage : ', data['dvec'].shape[0])   
